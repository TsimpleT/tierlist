...
import { HomePage, AggregateTierlistPage, MenuSavesPage, TierlistPage, ErrorPage, TournamentPage } from './Pages';
        ...
        return (
            <BrowserRouter>
                ...
                <Routes>
                    ...
                    <Route path="/tierlist/tournament" element={<TournamentPage />} />
